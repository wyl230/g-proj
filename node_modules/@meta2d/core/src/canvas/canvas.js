...
var Canvas = /** @class */ (function () {
    function Canvas(parent, parentElement, store) {
        ...
        this.onMouseDown = function (e) {
            ...
            // Set anchor of pen.
            if (_this.hotkeyType === HotkeyType.AddAnchor) {
                // console.log(_this.store.pointAt);
        ...
        this.render = function (patchFlags) {
            // _this.height=10;
            // console.log('canvas render', _this.width, _this.height);
            var now;
        ...
        this.ondblclick = function (e) {
            ...
            console.log('store', _this.store.hover); // 鼠标放置位置的组件
            console.log('store', _this.store.data);
            let text = _this.store.hover.text;
            if(_this.store.hover) {
                // todo: 传递当前硬件给后端，同时新建的画布上添加文字指示目前在哪个板卡中
                ...
                // var ctx = canvas.getContext('2d');
                // ctx.font = "30px Arial";
                // ctx.fillText(this.store.hover.text, 100, 110);
            } 
            return;
    ...
    Canvas.prototype.inAnchor = function (pt, pen, anchor) {
        console.log('inAnchor','pt', pt,'pen', pen,'anchor', anchor);
                ...
                switch (_d.label) {
                    ...
                    case 5:
                        ...
                        if (hoverPen.type === PenType.Line) {
                            ...
                            // ctx.fillText('test_interface', pt.x, pt.y); // 这里是组件中间位置的文字 只是一行
                        }
                        _d.label = 6;
                    case 6:
