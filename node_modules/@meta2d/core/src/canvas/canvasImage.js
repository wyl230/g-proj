...
var CanvasImage = /** @class */ (function () {
    function CanvasImage(parentElement, store, isBottom) {
        ...
        // this.canvas.style.backgroundSize = '10% 10%';
        this.canvas.style.position ='absolute';
        // this.canvas.style.position = 'static'; // 一直滑动 200%
        // this.canvas.style.position = 'relative'; // 一直滑动 200%
        this.canvas.style.top = '0';
        this.canvas.style.left = '0';
        // console.log('width', this.canvas.width, this.canvas.height);
    }
